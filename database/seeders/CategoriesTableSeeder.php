...
class CategoriesTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $categories = [
            ...
            ['slug' => 'stores',           'name' => 'المتاجر والمولات',            'icon' => 'المتاجر_المولات.png'],
            ...
            ['slug' => 'car-services',     'name' => 'خدمات وصيانه السيارات',      'icon' => 'خدمات_صيانه_السيارات.png'],
            ['slug' => 'home-services',    'name' => 'خدمات وصيانه المنازل',       'icon' => 'خدمات_صيانه_المنازل.png'],
            ['slug' => 'lighting-decor',   'name' => 'الإضاءه والديكور',         'icon' => 'الاضائه_الديكور.png'],
            ['slug' => 'animals',          'name' => 'طيور وحيوانات',             'icon' => 'طيور_حيوانات.png'],
            ['slug' => 'farm-products',    'name' => 'منتجات مزارع ومصانع',     'icon' => 'منتجات_مزارع_ومصانع.png'],
